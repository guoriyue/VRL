...
``tests/models/ar/fixtures.py`` for why), the LlamaGen GPT is *vendored*, so a
...
from vrl.models.ar.llamagen.model import LlamaGenConfig, LlamaGenModel
from vrl.models.ar.llamagen.vendor.gpt import ModelArgs, Transformer
...
class StubT5Encoder(nn.Module):
    ...
    def __init__(self, *, vocab_size: int = TINY_T5_VOCAB, caption_dim: int = TINY_CAPTION_DIM) -> None:
        super().__init__()
        torch.manual_seed(1)
...
def build_tiny_llamagen_model(
    ...
    **config_kwargs,
    ...
    from vrl.models.ar.llamagen.model import LlamaGenReplayModel
