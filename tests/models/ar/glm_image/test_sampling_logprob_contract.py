...
from tests.models.ar.glm_image.fixtures import TINY_CODEBOOK, TINY_VISION_VOCAB
from vrl.models.ar.glm_image.runner import GlmImageARState, GlmImageTokenRunner
...
def test_logprob_scored_under_unfiltered_conditional_not_topp_behavior() -> None:
    ...
    behavior_lp = F.log_softmax(
        scaled.masked_fill(~kept, float("-inf")), dim=-1,
    )
