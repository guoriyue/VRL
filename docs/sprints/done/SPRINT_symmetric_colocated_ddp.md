...
状态：**done（Slice 1–4 全落地、CPU 全绿，2026-06-18 归档至 done/；真 2 机×1 卡跨机 NCCL proof run 已端到端跑通（首次真机验证，见 [[SPRINT_ddp_2x1_first_run_findings]]）。Slice 1–4 的代码已实现，CPU 可验证部分全绿（2026-06-18，trainers+config+ray+online-lifecycle 396
