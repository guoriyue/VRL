...
真权重 rollout 验证（replay parity 0.0e+00；17B 走 CPU 验证，1024px/20 步复跑画质干净——首跑斑块
系 6 步/512px 探针省时设置）。短 GRPO 曲线未单独跑（战役按 rollout 验证关账，详见 index sprint
文件头验证记录）。**性质：新增大体量 T2I DiT 家族，套薄 seam，LoRA-only。
