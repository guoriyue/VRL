...
- 真 async sprint：`docs/sprints/done/SPRINT_continuous_scheduler_redesign.md`、`docs/sprints/done/SPRINT_shadow_model_weight_sync.md`、`docs/sprints/planned/SPRINT_async_rollout_train_overlap.md`
