...
状态：planned / prerequisite。本文是 `parked/SPRINT_multi_gpu_training.md` 的前置
...
- `docs/sprints/planned/SPRINT_global_ray_placement_owner.md`
...
- `/home/mingfeiguo/Desktop/wm-infra/docs/sprints/planned/SPRINT_global_ray_placement_owner.md`
