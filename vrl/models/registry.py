...
_REGISTRY: dict[str, str] = {
    ...
    "cosmos-predict2": "vrl.models.families.cosmos.predict2.policy:CosmosPredict2Policy",
    "cosmos-predict2.5": "vrl.models.families.cosmos.predict2_5.policy:CosmosPredict25Policy",
}
