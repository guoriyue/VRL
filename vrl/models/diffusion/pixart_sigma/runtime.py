...
``DiffusionFamilyBuild`` recipe on the pixart_sigma registry entry, and the
...
class PixArtSigmaChunkExecutor(DiffusionChunkExecutorBase):
    """Diffusion executor for PixArt-Sigma text-to-image rollouts.
