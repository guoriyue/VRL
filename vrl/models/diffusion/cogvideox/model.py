...
class CogVideoXReplayModel(ReplayRolloutStubs, CogVideoXModel):
    ...
    def pipeline(self) -> Any:
        raise RuntimeError("CogVideoXReplayModel does not own a diffusers pipeline")
