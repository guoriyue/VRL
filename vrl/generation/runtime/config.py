"""Backend configuration for generation execution."""
...
class GenerationRuntimeConfig:
    """Distributed generation execution config plus resolved worker resources."""
    ...
    @classmethod
    def from_cfg(cls, cfg: Any) -> GenerationRuntimeConfig:
        """Build generation runtime config from a full training cfg."""
    ...
    def to_dict(self) -> dict[str, Any]:
        """Return the flat config shape accepted by generation runtimes."""
        return {
