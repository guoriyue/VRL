"""Ray generation worker for chunk-level generation execution."""
...
from vrl.generation.ray.dependencies import (
    current_gpu_ids,
    current_node_ip,
    import_from_path,
)
from vrl.generation.ray.types import RayChunkExecutionEnvelope, RayChunkResult
...
class RayGenerationWorker:
    """Own one generation executor inside a Ray actor process."""
    ...
    def _profile_forward_chunk(
        ...
        try:
            ...
            logger.exception("Ray generation profiler-wrapped chunk failed")
            raise
