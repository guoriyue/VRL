...
class TokenScheduler:
    ...
    This is an executor-internal scheduler. The generation runtime owns
    ``GenerationRequest`` lifecycle; this class only batches token forwards
    after a Janus/NextStep executor has expanded requests into active
    sequences.
    """
...
__all__ = ["TokenBatch", "TokenScheduler"]
